...
public class URIConstants {
    ...
    //Summoner
    public static String SUMMONER = BASE_URL + "summoner/users?region={0}&name={1}";
    public static String SUMMONER_UPDATE = BASE_URL + "summoner/update?region={0}&name={1}";

    //Stats
    public static String SHARDS = BASE_URL + "status/shards";

    //League
    public static String LEAGUE_ENTRY = BASE_URL + "league/summoner?region={0}&id={1}";
