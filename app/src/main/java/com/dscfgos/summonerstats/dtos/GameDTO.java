...
public class GameDTO
{
    ...
    private String spell1Key	;						// - Key of first summoner spell.
    private String spell2Key	;						// - Key of second summoner spell.
    ...
    public String getSpell1Key() {
        return spell1Key;
    }

    public void setSpell1Key(String spell1Key) {
        this.spell1Key = spell1Key;
    }

    public String getSpell2Key() {
        return spell2Key;
    }

    public void setSpell2Key(String spell2Key) {
        this.spell2Key = spell2Key;
    }
}
