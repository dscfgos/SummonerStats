...
{
    private int	assists ;
    private int barracksKilled ; 				// - Number of enemy inhibitors killed.
    ...
    private boolean nexusKilled ; 				// - Flag specifying if the summoner got the killing blow on the nexus.
